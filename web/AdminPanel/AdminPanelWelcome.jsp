<%-- 
    Document   : AdminPanelWelcome
    Created on : Oct 9, 2014, 12:33:43 PM
    Author     : aa
--%>
...
<div class="gridContainer clearfix">
  ...
  <nav>
      ...
      <ul class="nav" style="min-width: 0px;">
       ...
       <li><a href="AdminPanel.jsp">Admin Panel Home</a></li>
    ...
    <li><a href="#">Record Management</a>
      <ul>
          <li><a href="AddRecord.jsp">Add Record</a></li>
          <li><a href="EditRecord.jsp?srt=rid">Edit Record</a></li>
          <li><a href="PostInfo.jsp">Add Record Information</a></li>
